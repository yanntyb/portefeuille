...
class InvestissementLocatifSimulation
{
    public static function build(): Simulation
    {
        ...
        $sharedParams = [
            new SimulationObject('taux_interet_annuel', SimulationValue::percent(0.035), null, null, []),
            new SimulationObject('duree_credit_annees', SimulationValue::plain(20), null, null, []),
            new SimulationObject('taux_assurance_emprunteur', SimulationValue::percent(0.0034), null, null, []),
            new SimulationObject('tmi', SimulationValue::percent(0.30), null, null, []),
            new SimulationObject('taux_prelevements_sociaux', SimulationValue::percent(0.172), null, null, []),
        ];
    ...
    private static function buildPropertyPipeline(string $pipelineName, string $prefix, array $defaults): array
    {
        ...
        foreach ($defaults as $name => $value) {
            if (in_array($name, $percentParams)) {
                $params[] = new SimulationObject($p($name), SimulationValue::percent($value), $pipelineName, null, []);
            } else {
                $params[] = new SimulationObject($p($name), SimulationValue::euro($value), $pipelineName, null, []);
            }
        }
        ...
        $calcs = [
            // 1. frais_notaire
            new SimulationObject($p('frais_notaire'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('prix_achat'), 'reference'),
                new SimulationStep('*', 'operator'),
                new SimulationStep($p('frais_notaire_taux'), 'reference'),
            ]),
            // 2. cout_acquisition
            new SimulationObject($p('cout_acquisition'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('prix_achat'), 'reference'),
                new SimulationStep('+', 'operator'),
            ...
            // 3. capital_emprunte
            new SimulationObject($p('capital_emprunte'), SimulationValue::euro(0), $pipelineName, null, [
            ...
            new SimulationObject($p('mensualite_credit'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('capital_emprunte'), 'reference'),
                new SimulationStep('mensualite_credit', 'function'),
            ]),
            // 5. assurance_mensuelle
            new SimulationObject($p('assurance_mensuelle'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('capital_emprunte'), 'reference'),
                new SimulationStep('*', 'operator'),
            ...
            // 6. mensualite_totale
            new SimulationObject($p('mensualite_totale'), SimulationValue::euro(0), $pipelineName, null, [
            ...
            new SimulationObject($p('taux_occupation'), SimulationValue::percent(0), $pipelineName, null, [
                new SimulationStep('1', 'value'),
                new SimulationStep('-', 'operator'),
                new SimulationStep($p('taux_vacance'), 'reference'),
            ]),
            // 8. loyer_annuel_brut
            new SimulationObject($p('loyer_annuel_brut'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('loyer_mensuel'), 'reference'),
                new SimulationStep('*', 'operator'),
                new SimulationStep('12', 'value'),
            ]),
            // 9. loyer_annuel_effectif
            new SimulationObject($p('loyer_annuel_effectif'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('loyer_annuel_brut'), 'reference'),
                new SimulationStep('*', 'operator'),
                new SimulationStep($p('taux_occupation'), 'reference'),
            ]),
            // 10. frais_gestion_annuels
            new SimulationObject($p('frais_gestion_annuels'), SimulationValue::euro(0), $pipelineName, null, [
            ...
            new SimulationObject($p('total_charges_annuelles'), SimulationValue::euro(0), $pipelineName, null, [
            ...
            new SimulationObject($p('remboursement_annuel'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('mensualite_totale'), 'reference'),
                new SimulationStep('*', 'operator'),
                new SimulationStep('12', 'value'),
            ]),
            // 13. rendement_brut (%)
            new SimulationObject($p('rendement_brut'), SimulationValue::percent(0), $pipelineName, null, [
                new SimulationStep($p('loyer_annuel_brut'), 'reference'),
                new SimulationStep('/', 'operator'),
                new SimulationStep($p('cout_acquisition'), 'reference'),
            ]),
            // 14. revenu_imposable (micro-foncier, abattement 30%)
            new SimulationObject($p('revenu_imposable'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('loyer_annuel_effectif'), 'reference'),
                new SimulationStep('*', 'operator'),
                new SimulationStep('0,70', 'value'),
            ]),
            // 15. impot
            new SimulationObject($p('impot'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('revenu_imposable'), 'reference'),
                new SimulationStep('*', 'operator'),
                new SimulationStep('tmi', 'reference'),
            ]),
            // 16. prelevements_sociaux
            new SimulationObject($p('prelevements_sociaux'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('revenu_imposable'), 'reference'),
                new SimulationStep('*', 'operator'),
                new SimulationStep('taux_prelevements_sociaux', 'reference'),
            ]),
            // 17. fiscalite_totale
            new SimulationObject($p('fiscalite_totale'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('impot'), 'reference'),
                new SimulationStep('+', 'operator'),
                new SimulationStep($p('prelevements_sociaux'), 'reference'),
            ]),
            // 18. revenu_net
            new SimulationObject($p('revenu_net'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('loyer_annuel_effectif'), 'reference'),
                new SimulationStep('-', 'operator'),
            ...
            // 19. cash_flow_annuel
            new SimulationObject($p('cash_flow_annuel'), SimulationValue::euro(0), $pipelineName, null, [
            ...
            new SimulationObject($p('cash_flow_mensuel'), SimulationValue::euro(0), $pipelineName, null, [
                new SimulationStep($p('cash_flow_annuel'), 'reference'),
                new SimulationStep('/', 'operator'),
                new SimulationStep('12', 'value'),
            ]),
            // 21. rendement_net_net (resultat cle, %)
            new SimulationObject($p('rendement_net_net'), SimulationValue::percent(0), $pipelineName, null, [
                new SimulationStep($p('revenu_net'), 'reference'),
                new SimulationStep('/', 'operator'),
                new SimulationStep($p('cout_acquisition'), 'reference'),
            ]),
