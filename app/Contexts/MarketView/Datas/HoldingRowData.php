 ...
 *
 * Treize clés pour onze propriétés : `typeLabel` et `assetClassLabel` se dérivent de leur enum au
 * moment de sérialiser, jamais recopiés en chaînes à la construction — sinon le libellé affiché
 * cesserait de suivre l'enum le jour où celui-ci change.
 */
