...
use App\Contexts\PortfolioView\Datas\InstrumentAnalysisData;
 ...
 * calculateurs des contextes propriétaires font les formules, cette action ne fait que les
 ...
 * laquelle se décide la taille d'un renfort — d'où l'action plutôt qu'un aperçu par exposition.
 */
class GetInstrumentAnalysis
{
    ...
    public function __invoke(int $userId, int $assetId): ?InstrumentAnalysisData
    {
