...
const props = defineProps<{
    /**
     * `null` : les positions différées ne sont pas encore arrivées ; la page d'exposition, qui
     * sert `overview` en synchrone, passe toujours un tableau.
     */
     ...
     * surveiller tant que `holdings` reste `null`. Sans objet sur la page d'exposition, qui sert
...
<template>
    <CollapsibleSection section="instruments" title="Instruments" aria-label="Instruments">
        ...
        <template v-if="props.holdings !== null">
