...
<template>
    ...
    <main class="min-h-screen overflow-x-hidden bg-background py-6 text-foreground">
        <div class="mx-auto flex max-w-6xl flex-col gap-6">
            <section v-if="overview.holdings.length" data-section="valuation" class="flex flex-col gap-0.5 px-6">
            ...
            <section data-section="evolution" :class="['flex flex-col gap-3 transition-opacity', reloading ? 'opacity-50' : '']">
                <div class="flex flex-col gap-2 px-6">
                    <p class="text-sm text-muted-foreground">Valeur de marché par titre</p>
            ...
            <section v-if="overview.holdings.length" data-section="performances" class="px-6">
